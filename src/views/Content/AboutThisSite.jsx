...
export function AboutThisSite() {
  ...
  return (
    <div className={classes.root}>
      ...
      <Typography gutterBottom variant={"body1"}>
        While I hope to eventually get most or all of the development side
        projects I've been involved in onto the site, the site is itself the
        primary workspace for things I am learning/experimenting with and is the
        most comprehensive showcase of mine available at the moment. I doubt
      ...
      <Typography gutterBottom variant={"body1"}>
        ...
        hub for managing by frontend and backend environments and covers
      ...
      <Typography gutterBottom variant={"body1"}>
        ...
        mobile resolutions. A comprehensive CI/CD pipeline that automatically
        scales, is trivial to set up, and is fully customizeable.
      </Typography>
      <img
        style={{
          width: "80%",
      ...
      <Typography gutterBottom variant={"body1"}>
        ...
        player, pose to name a few) that I were out of scope of my projects at
        NoveList. We, at the time, had just gotten our feet wet with material
        design and material UI and so I from the start that I wanted to lean on
        those principles and components. Things have not changed much as far as
        the approach for this version of the site. I am by no means a UX or web
        design expert. I refer to the principles of material design for
      ...
      <Typography gutterBottom variant={"body1"}>
        ...
        Components are meant as generic pieces optimized for reuse, building
        blocks. Layouts are groups of components grouped together in common
        ways. Layouts are also concerned with reuse like, for example, the tab
        panels on this site. A view is the top level assemblage of of layouts
        and possibly other one off components that are needed. Everything I've
        described here would be considered a 'presentational component',
        borrowing the term first coined by Dan Abramov when dividing components
        into those that are smart (containers) and dumb (presenters). Seperating
        requests to a data store from your presentational logic is essential for
        reusing pieces of the UI and is a logical seperation givin the
        compositional nature of react. The best example in my project so far is
        the implementation of the tab sections. All of the content sections of a
        tab are basically the same - a grid of cards with thumbnails and
        descriptions, etc. The fetch request needed to populate the data is
        different for each though, hitting different parts of the API and
        different tables in the db. Each container can reach out to the api and
        get its data and populate the common ItemContent component reused by
        each
      </Typography>
      <Typography gutterBottom variant={"subtitle2"}>
        Design
      ...
      <Typography gutterBottom variant={"body1"}>
        An approach I took (at least for this first implementation) was meant to
        be something of an 'uber-SPA' (there's probably a real name for this).
        ...
        sparingly because they are "purposefully interruptive". Not a principle
        I disagree with, by the way. Most of us supress some level of rage or
        nausea when confronted with a startling and unwelcome popup window. That
        said, the use of the dialog in this instance feels very much like a
        navigation without the loss of navigation context. In this way the user
        has a better sense of where they are, avoiding the all to familiar
        feeling that you are so deep in the labyrinth of a web app that you may
        never find your way out. The user is the only place they can be on the
        site - home.
      </Typography>
      <Typography gutterBottom variant={"body1"}>
        ...
        this screen" and I wanted to avoid that here. The main view should
        always feel spacious - elements on the page should have room to breath.
        At the same time, if the layout is too sparse it conveys a lack of
        content. The site should have a certain 'meatiness' to it, expressing
        that there is a lot you want to share with the user to maintain their
        engagement. I am generally suspicious of icon buttons without helper
        text. Too frequently the user has to click to see what the thing does.
        That said, there is a subset of icons that are so common that there
        meaning is universal. Clicking a ✗ will close the element it's attached
        to, always. The print icon, settings cog, hamburger menu and envelope
        icon are all similarly intuitive. I have limited the icon buttons on the
        site to those that I had high confidence any user would understand at a
        glance.
      </Typography>
      <Typography gutterBottom variant={"body1"}>
        ...
        the ability to set the theme color from the site from the settings menu.
